...
def show_registration_page(detector, embedder):
    """
    The user panel manages the registration form and its logic.
    ...
    with st.form("registration_form", clear_on_submit=True):
        ...
        if submit_btn:
            full_name = full_name.strip() # Remove Unneccesary spaces
            ...
            if not full_name:
                ...
                with st.spinner("Saving images and analyzing face..."):
                    ...
                    # 1. Create a new folder inside known_faces with the person’s name.
                    ...
                    # 2. Save every uploaded image in folder
