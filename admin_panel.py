...
def show_admin_panel(menu, detector, embedder):
    ...
    if menu == "Live Webcam":
        ...
        if run_camera:
            ...
            if not saved_embeddings:
                ...
                frame_counter = 0
                frame_skip_rate = 30  
                current_face_data = [] # Faces of previous frame
                ...
                try:
                    while run_camera:
                        ...
                        if frame_counter % frame_skip_rate == 0:
                            ...
                            new_face_data = [] # New updated faces
                            
                            for face in detected_faces:
                                x1, y1, x2, y2 = face['box']
                                
                                # 1. Center (Centroid) of New Faces
            ...
            if not saved_embeddings:
                ...
                with st.spinner("Analyzing image..."):
                    ...
                    if len(detected_faces) == 0:
                        ...
                        st.image(image_rgb, caption="Search Result", use_container_width=True)
    ...
    # 5. VIEW ALL COMPLAINTS MODULE
        ...
        # To show table connecting database
        conn = sqlite3.connect(database.DB_NAME)
        # Removed the embedding column from the query because it is BLOB/Binary data, which cannot be displayed in the table.
        ...
        if df.empty:
            ...
            # With `hide_index=True`, the row numbers (0,1,2..) will not be shown, making the UI look cleaner.
