...
def show_multi_camera_panel(detector, embedder):
    ...
    if run_multi:
        ...
        # 2. Layout Grid Setup (both cameras side-by-side interface)
        ...
        # If the user enters '0', it must be converted to the integer 0 for the webcam.
        ...
        # Different tracking variables for both cameras
        frame_counter = 0
        frame_skip_rate = 30
        face_data_cam1 = []
        face_data_cam2 = []
            ...
            with st.spinner("Connecting to both camera networks..."):
                while run_multi:
                    ...
                    if ret1:
                        ...
                        frame_window1.image(cv2.cvtColor(frame1, cv2.COLOR_BGR2RGB), use_container_width=True)
                    ...
                    if ret2:
                        ...
                        frame_window2.image(cv2.cvtColor(frame2, cv2.COLOR_BGR2RGB), use_container_width=True)
