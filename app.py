...
panel = st.sidebar.selectbox("Select Panel", ["User Panel", "Admin Panel"])
st.sidebar.write("Menu")

if panel == "User Panel":
    menu = st.sidebar.radio("", ["Register Missing Person"])
...
# User Module Call
if panel == "User Panel" and menu == "Register Missing Person":
